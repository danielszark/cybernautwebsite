...
const boxData = [
  ...
  { header: "Cybernaut",
    content:
      "Entering the site reveals a user’s personal companion, Cybernaut. Cybernaut is a digital character that accompanies the user into the story and helps them navigate the challenges they will face."
  },

  { header: "Progress Bar",
    content:
      "Each game section contains a progress bar that shows the user how far along they are in the section. Each progress bar is also tied to XP points, another gamifying feature linked to user accounts."
  }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        {boxData.map((box, idx) => (
          ...
          >
            ...
            <p className="text-black text-lg">{box.content}</p>
          </div>
        ))}
      </div>
