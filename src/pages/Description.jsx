...
const Description = () => {
  return (
    <div className="bg-[#f0f4f8] min-h-screen text-center p-6 flex flex-col items-center">
      <h1 className="font-zing text-4xl font-bold text-[#275481] mb-10">Project Description</h1>
      <div className="flex flex-col items-center space-y-10 w-full">
        {/*boxData.map - Array.map() method. Method for javascript that adds a method to each array item. Box represents a specific item in the boxData array. IDX represents the index of the current item*/}
        {/*key={idx} is used to give each element in a list a unique identifier*/} 
        {boxData.map((box, idx) => (
          <div
            key={idx}
